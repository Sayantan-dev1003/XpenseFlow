          ...
          <form onSubmit={handleSubmit} className="space-y-8">
            ...
            <div className="flex space-x-3">
              ...
              <Button
                type="button"
                variant="outline"
                className="flex-1 py-3 border border-gray-300 text-gray-700 hover:bg-gray-50 font-medium"
            ...
            <div className="space-y-1">
              <div className="relative">
                ...
                <select className="w-full pl-10 pr-4 py-3 border border-gray-300 rounded-lg outline-purple-500 appearance-none bg-white">

...
import { FiPlus, FiDollarSign, FiUpload, FiLogOut, FiChevronDown } from 'react-icons/fi';
    ...
    <div className="p-6">
      ...
      <div className="pb-4 mb-12 border-b border-gray-300">
        <div className="flex justify-between items-start">
          <div>
            <h1 className="text-3xl font-bold text-gray-900">XpenseFlow</h1>

          </div>
          <div className='flex gap-4 justify-center items-baseline'>
            <div>
              <p className="text-gray-600 text-xl font-bold">{user.firstName} {user.lastName}</p>
              <p className="text-gray-600 text-xl font-bold">{user.role}</p>
            </div>
            <button
              onClick={logout}
      ...
      <p className="text-gray-600 text-xl font-bold mb-4">Welcome back, {user.firstName}! Track and submit your expenses.</p>
            ...
            {filteredExpenses.length > 0 ? (
              ...
              <div className="text-center py-8">
                ...
                <p className="text-sm text-gray-400">
                  {statusFilter === 'all' ? 'Submit your first expense to get started' : 'Try selecting a different status filter'}
                </p>
              </div>
            )}
          </div>
